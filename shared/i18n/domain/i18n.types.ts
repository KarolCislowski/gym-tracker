...
export interface TranslationDictionary {
  ...
  dashboard: {
    ...
    nextActionProfileTitle: string;
    nextActionProfileDescription: string;
    nextActionProfileCta: string;
    nextActionGoalsTitle: string;
    nextActionGoalsDescription: string;
    nextActionGoalsCta: string;
    nextActionFirstDailyReportTitle: string;
    nextActionFirstDailyReportDescription: string;
    nextActionFirstDailyReportCta: string;
    nextActionFirstWorkoutTitle: string;
    nextActionFirstWorkoutDescription: string;
    nextActionFirstWorkoutCta: string;
    nextActionTodayDailyReportTitle: string;
    nextActionTodayDailyReportDescription: string;
    nextActionTodayDailyReportCta: string;
    nextActionThisWeekWorkoutTitle: string;
    nextActionThisWeekWorkoutDescription: string;
    nextActionThisWeekWorkoutCta: string;
    nextActionReviewProgressTitle: string;
    nextActionReviewProgressDescription: string;
    nextActionReviewProgressCta: string;
    analyticsTitle: string;
    customizeDashboardLabel: string;
    ...
    resetDashboardLayoutLabel: string;
    cancelDashboardCustomization: string;
    saveDashboardLayoutLabel: string;
    compactSizeLabel: string;
    regularSizeLabel: string;
    wideSizeLabel: string;
