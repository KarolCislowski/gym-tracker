...
function getWidgetChrome(
  ...
  switch (tone) {
    case 'accent':
      return {
        backgroundColor: mode === 'dark' ? 'rgba(15, 23, 42, 0.92)' : '#f8fbff',
        backgroundImage:
          mode === 'dark'
            ? 'linear-gradient(155deg, rgba(59,130,246,0.18), rgba(15,23,42,0.96) 58%, rgba(14,165,233,0.12))'
            : 'linear-gradient(155deg, rgba(255,255,255,0.96), rgba(239,246,255,0.98) 52%, rgba(224,242,254,0.92))',
        borderColor: mode === 'dark' ? 'rgba(96, 165, 250, 0.22)' : 'rgba(59, 130, 246, 0.16)',
        boxShadow:
          mode === 'dark'
        ...
        overlay:
          mode === 'dark'
            ...
            : 'radial-gradient(circle at top right, rgba(125,211,252,0.24), transparent 36%), radial-gradient(circle at bottom left, rgba(191,219,254,0.28), transparent 40%)',
      };
    case 'soft':
      return {
        ...
        borderColor: mode === 'dark' ? 'rgba(148, 163, 184, 0.16)' : 'rgba(148, 163, 184, 0.18)',
        boxShadow:
          mode === 'dark'
    ...
    case 'glass':
      return {
        backgroundColor: mode === 'dark' ? 'rgba(15, 23, 42, 0.76)' : 'rgba(255, 255, 255, 0.7)',
        backgroundImage:
          mode === 'dark'
        ...
        borderColor: mode === 'dark' ? 'rgba(148, 163, 184, 0.18)' : 'rgba(255, 255, 255, 0.55)',
        boxShadow:
          mode === 'dark'
    ...
    default:
      return {
        ...
        borderColor: mode === 'dark' ? 'rgba(148, 163, 184, 0.14)' : 'rgba(148, 163, 184, 0.16)',
        boxShadow:
          mode === 'dark'
            ? '0 14px 32px rgba(2, 6, 23, 0.3)'
            : '0 12px 30px rgba(148, 163, 184, 0.1)',
