...
export const plMessages: TranslationDictionaryOverrides = {
  ...
  dashboard: {
    ...
    activityCalendarTitle: 'Kalendarz aktywności',
    activityCalendarDescription:
      'Wybierz dzień, aby sprawdzić jakie raporty zostały zapisane i szybko przejść do szczegółów.',
    activityCalendarEmptyDay: 'Dla tego dnia nie zapisano jeszcze raportów.',
    activityCalendarNoEntries: 'W tym miesiącu nie ma jeszcze wpisów.',
    activityCalendarDailyReportLabel: 'Raport dzienny',
    activityCalendarWorkoutReportsLabel: 'Raporty treningowe',
    activityCalendarOpenDailyReport: 'Otwórz raport dzienny',
    activityCalendarOpenWorkout: 'Otwórz trening',
    activityCalendarPreviousMonth: 'Poprzedni miesiąc',
    activityCalendarNextMonth: 'Następny miesiąc',
    settingsLanguage: 'Język',
    ...
    summaryMetricsTitle: 'Sygnały ciała i nawyków',
    bodyMassIndexLabel: 'BMI',
    proteinPerKgBodyWeightLabel: 'Białko na kg masy ciała',
    hydrationAdherenceTrendLabel: 'Realizacja nawodnienia',
    sleepConsistencyLabel: 'Regularność snu',
    macroAdherenceScoreLabel: 'Wynik realizacji makro',
    bmiCategoryUnderweight: 'Niedowaga',
    bmiCategoryNormal: 'Norma',
    bmiCategoryOverweight: 'Nadwaga',
    bmiCategoryObesity: 'Otyłość',
    ...
    customizeDashboardLabel: 'Dostosuj dashboard',
    customizeDashboardTitle: 'Dostosuj swój dashboard',
    ...
    resetDashboardLayoutLabel: 'Przywróć układ domyślny',
    cancelDashboardCustomization: 'Anuluj',
    saveDashboardLayoutLabel: 'Zapisz układ',
    compactSizeLabel: 'Kompaktowy',
    regularSizeLabel: 'Standardowy',
    wideSizeLabel: 'Szeroki',
    ...
    dashboardLayoutErrorGeneric:
      'Nie udało się zaktualizować układu dashboardu. Spróbuj ponownie.',
  ...
  supplementation: {
    ...
    stackError: 'Nie udało się zapisać zmian w stacku suplementacyjnym.',
    reportError: 'Nie udało się zapisać raportu suplementacji.',
  ...
  workouts: {
    ...
    templateError: 'Nie udało się zapisać templateki treningu.',
