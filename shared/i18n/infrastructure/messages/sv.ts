...
export const svMessages: TranslationDictionaryOverrides = {
  ...
  dashboard: {
    ...
    activityCalendarTitle: 'Aktivitetskalender',
    activityCalendarDescription:
      'Välj en dag för att se vilka rapporter som loggades och hoppa direkt till detaljerna.',
    activityCalendarEmptyDay: 'Inga rapporter loggades för den här dagen ännu.',
    activityCalendarNoEntries: 'Det finns inga poster den här månaden ännu.',
    activityCalendarDailyReportLabel: 'Daglig rapport',
    activityCalendarWorkoutReportsLabel: 'Träningsrapporter',
    activityCalendarOpenDailyReport: 'Öppna daglig rapport',
    activityCalendarOpenWorkout: 'Öppna träningspass',
    activityCalendarPreviousMonth: 'Föregående månad',
    activityCalendarNextMonth: 'Nästa månad',
    settingsLanguage: 'Språk',
    ...
    summaryMetricsTitle: 'Kropps- och vanesignaler',
    bodyMassIndexLabel: 'BMI',
    proteinPerKgBodyWeightLabel: 'Protein per kg kroppsvikt',
    hydrationAdherenceTrendLabel: 'Vätskeefterlevnad',
    sleepConsistencyLabel: 'Sömnkonsekvens',
    macroAdherenceScoreLabel: 'Makroefterlevnad',
    bmiCategoryUnderweight: 'Undervikt',
    bmiCategoryNormal: 'Normal',
    bmiCategoryOverweight: 'Övervikt',
    bmiCategoryObesity: 'Fetma',
