...
const tenantDailyReportSchema = new Schema<TenantDailyReport>(
  {
    ...
    goalsSnapshot: {
      type: {
        ...
        caloriesPerDay: nullableNumberField,
        carbsGramsPerDay: nullableNumberField,
        proteinGramsPerDay: nullableNumberField,
        fatGramsPerDay: nullableNumberField,
    ...
    actuals: {
      type: {
        ...
        calories: nullableNumberField,
        carbsGrams: nullableNumberField,
        proteinGrams: nullableNumberField,
        fatGrams: nullableNumberField,
    ...
    completion: {
      type: {
        ...
        caloriesGoalMet: nullableBooleanField,
        carbsGoalMet: nullableBooleanField,
        proteinGoalMet: nullableBooleanField,
        fatGoalMet: nullableBooleanField,
