...
export async function listTenantDailyReportRecords(
  ...
  return reports.map((report) => ({
    ...
    completion: {
      ...
      caloriesGoalMet: report.completion?.caloriesGoalMet ?? null,
      carbsGoalMet: report.completion?.carbsGoalMet ?? null,
      proteinGoalMet: report.completion?.proteinGoalMet ?? null,
      fatGoalMet: report.completion?.fatGoalMet ?? null,
    ...
    actuals: {
      ...
      calories: report.actuals?.calories ?? null,
      carbsGrams: report.actuals?.carbsGrams ?? null,
      proteinGrams: report.actuals?.proteinGrams ?? null,
      fatGrams: report.actuals?.fatGrams ?? null,
...
export async function findTenantDailyReportRecordById(
  ...
  return {
    ...
    goalsSnapshot: {
      ...
      caloriesPerDay: report.goalsSnapshot?.caloriesPerDay ?? null,
      carbsGramsPerDay: report.goalsSnapshot?.carbsGramsPerDay ?? null,
      proteinGramsPerDay: report.goalsSnapshot?.proteinGramsPerDay ?? null,
      fatGramsPerDay: report.goalsSnapshot?.fatGramsPerDay ?? null,
