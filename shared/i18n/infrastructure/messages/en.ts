...
export const enMessages: TranslationDictionary = {
  ...
  dashboard: {
    ...
    activityCalendarDescription:
      'Pick a day to review which reports were logged and jump straight into the details.',
    activityCalendarEmptyDay: 'No reports logged for this day yet.',
    activityCalendarNoEntries: 'No entries in this month yet.',
    activityCalendarDailyReportLabel: 'Daily report',
    activityCalendarWorkoutReportsLabel: 'Workout reports',
    activityCalendarOpenDailyReport: 'Open daily report',
    activityCalendarOpenWorkout: 'Open workout',
    activityCalendarPreviousMonth: 'Previous month',
    activityCalendarNextMonth: 'Next month',
    settingsLanguage: 'Language',
    ...
    summaryMetricsTitle: 'Body and habit signals',
    bodyMassIndexLabel: 'BMI',
    proteinPerKgBodyWeightLabel: 'Protein per kg body weight',
    hydrationAdherenceTrendLabel: 'Hydration adherence',
    sleepConsistencyLabel: 'Sleep consistency',
    macroAdherenceScoreLabel: 'Macro adherence score',
    bmiCategoryUnderweight: 'Underweight',
    bmiCategoryNormal: 'Normal',
    bmiCategoryOverweight: 'Overweight',
    bmiCategoryObesity: 'Obesity',
    ...
    customizeDashboardLabel: 'Customize dashboard',
    customizeDashboardTitle: 'Customize your dashboard',
    ...
    resetDashboardLayoutLabel: 'Reset layout',
    cancelDashboardCustomization: 'Cancel',
    saveDashboardLayoutLabel: 'Save layout',
    compactSizeLabel: 'Compact',
    regularSizeLabel: 'Regular',
    wideSizeLabel: 'Wide',
    tallSizeLabel: 'Tall',
    heroSizeLabel: 'Hero',
    ...
    dashboardLayoutErrorGeneric:
      'Could not update the dashboard layout. Please try again.',
    signOut: 'Sign out',
  ...
  supplementation: {
    ...
    stackError: 'Something went wrong while saving the supplement stack.',
    reportError: 'Something went wrong while saving the supplement report.',
    ...
    updateReportLabel: 'Save report changes',
  ...
  workouts: {
    ...
    templateError: 'Something went wrong while saving the workout template.',
